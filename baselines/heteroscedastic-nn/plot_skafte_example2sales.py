...
# Heteroscedastic
    ...
    # RMSE_mean = get_RMSE(f, f_mu)
    # RMSE_var_f = get_RMSE(s, f_var)
    # RMSE_var_y = get_RMSE(s, y_var)

    # RMAE_mean = get_RMAE(f, f_mu)
    # RMAE_var_f = get_RMAE(s, f_var)
    # RMAE_var_y = get_RMAE(s, y_var)
    
    # RMSE_var_m_map = np.mean(mh_map)
    # RMSE_var_s_map = np.mean(sh_map)
