...
# Sales data:
sales_data = np.load("./Baseline/bikes.npz")
...
# Heteroscedastic
model = MLP(input_size=15, width=128, depth=1, output_size=2, activation='relu', head=None).to(device).double()
...
save_path = "/home/local/ASURITE/longchao/Desktop/project/HeteroscedasticUnc/Effective Bayesian Heteroscedastic Regressionwith Deep Neural Networks/heteroscedastic-nn/Baseline/save_output/bike/" + current_time + "/"
