...
torch.manual_seed(109) # 711 , # 600 # 400, # 37 # 109
device = 'cpu'
n_samples = 1000
lr = 1e-2
lr_min = 1e-5
...
# Sales data:
sales_data = np.load("./Baseline/prescriptions.npz")
...
# Heteroscedastic
model = MLP(input_size=5, width=128, depth=1, output_size=2, activation='relu', head=None).to(device).double()
