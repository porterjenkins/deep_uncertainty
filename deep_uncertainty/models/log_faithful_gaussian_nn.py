...
class LogFaithfulGaussianNN(DiscreteRegressionNN):
    """Implementation of https://arxiv.org/abs/2212.09184 that internally regresses logmu instead of mu.

    The outputs of this network are identical to `FaithfulGaussianNN`, but we handle the regression of mu differently.
    ...
    def __init__(
        ...
        """Instantiate a LogFaithfulGaussianNN.
        ...
        Args:
            ...
            lr_scheduler_kwargs (dict | None): If specified, key-value argument specifications for the chosen lr scheduler, e.g. {"T_max": 500}.
        """
        super(LogFaithfulGaussianNN, self).__init__(
