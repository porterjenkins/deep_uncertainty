...
def main(config: dict):
    ...
    X_trn, y_trn = generator(
        num_points=config["n_train"], x_min=config["x_min"], x_max=config["x_max"]
    )

    X_val, y_val = generator(
        num_points=config["n_val"], x_min=config["x_min"], x_max=config["x_max"]
    )

    X_test, y_test = generator(
        num_points=config["n_test"], x_min=config["x_min"], x_max=config["x_max"]
    )
